...
const ClanDetailPage = async ({ params }: ClanDetailPageProps) => {
    ...
    return (
        <main className="container mx-auto p-4 md:p-8 mt-10">
            {/* [PERBAIKAN TAMPILAN v3]
              Mengembalikan ke 'items-center' agar judul rata tengah
              secara vertikal dengan blok tombol (terutama di layar kecil).
            */}
            ...
            <section className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <aside className="lg:col-span-1 card-stone p-6 h-fit sticky top-28 rounded-lg z-10">
                    <div className="space-y-6"> {/* Wrapper BARU untuk spasi antar blok */}

                        {/* Blok 1: Info Klan Inti (Blok pertama, tanpa border-t) */}
                        <div className="space-y-4"> {/* Spasi internal BARU */}
                        ...
                        {/* Blok 2: Reputasi Tim */}
                        <div className="space-y-4 pt-6 border-t border-coc-gold-dark/30"> {/* Pemisah BARU */}
                            {/* [PERBAIKAN TAMPILAN 2]
                              Judul "Reputasi Tim" rata tengah.
                            */}
