...
// Menggunakan ikon-ikon yang sudah diperbarui dan dikoreksi + BriefcaseIcon untuk Free Agent
import { ArrowLeftIcon, StarIcon, TrophyIcon, InfoIcon, GlobeIcon, DiscordIcon, LinkIcon, UserIcon, CheckIcon, AlertTriangleIcon, BriefcaseIcon, ShieldCheckIcon } from '@/app/components/icons';
                 ...
                 <aside className="lg:col-span-1 card-stone p-6 h-fit sticky top-28 space-y-6 text-center rounded-lg"> {/* Added rounded-lg */}
                     ...
                     <div className="text-left pt-4 border-t border-coc-gold-dark/20 space-y-4">
                         <h3 className="text-lg text-coc-gold-dark font-clash flex items-center gap-2">
                             {/* PERBAIKAN: Mengganti CogsIcon dengan InfoIcon yang lebih sesuai */}
                                 ...
                                 {isVerified && player.clanTag && (
                                     <div className="bg-coc-stone/50 p-4 rounded-lg border border-coc-gold-dark/30 col-span-2">
                                         <Link href={`/clan/${encodeURIComponent(player.clanTag)}`} className="hover:opacity-80 transition-opacity">
                                             <h4 className="text-lg text-coc-gold font-mono">{player.clanTag}</h4>
                                             <p className="text-xs uppercase text-gray-400 font-sans">Klan CoC Saat Ini</p>
                                         </Link>
                                     </div>
                                 )}
                             </div>
