...
import {
  UserProfile,
  // ManagerRole, // <-- HAPUS DARI SINI
  // StandardMemberRole, // <-- HAPUS DARI SINI
} from '@/lib/clashub.types'; // PERBAIKAN: Impor ManagerRole & StandardMemberRole
import {
  ClanRole,
  ManagerRole, // <-- TAMBAHKAN DI SINI
  StandardMemberRole, // <-- TAMBAHKAN DI SINI
} from '@/lib/enums';
...
  // PERBAIKAN: Tipe return di atas diubah dari UserProfile['role']
  // menjadi ManagerRole | StandardMemberRole (menghilangkan | undefined)
  // Ini menyelesaikan error TS2345 di baris 139 & 170.
