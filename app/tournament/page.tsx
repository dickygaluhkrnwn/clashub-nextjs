...
// [PERBAIKAN] Impor FirestoreDocument karena fungsi Admin mengembalikannya
// [PERBAIKAN] Ganti ke clashub.types agar eksplisit
import { Tournament, FirestoreDocument } from '@/lib/clashub.types';
// [BARU] Impor fungsi Admin SDK
...
        return (
            // [PERBAIKAN] Hapus <main> di sini, ganti dengan <div>
...
    // [PERBAIKAN] HAPUS <main> DARI SINI
    return (
        <TournamentClient
