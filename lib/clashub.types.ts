...
// ... (Kode JoinRequest tidak berubah)
 */
...
 * [PERBAIKAN] Tipe ini sekarang extends CocWarLogEntry, bukan Omit<CocWarLog>.
s */
export interface WarArchive extends CocWarLogEntry {
  // Properti dari CocWarLogEntry (result, teamSize, clan, opponent, endTime: string) di-inherit
  
