...
    POSTS: 'posts',
    TOURNAMENTS: 'tournaments', // PERBAIKAN 1: Tambahkan koleksi Tournaments
}
...
            clanRole: data.clanRole || ClanRole.NOT_IN_CLAN, // PERBAIKAN 2: Menggunakan Enum untuk menghindari Error TypeScript
...
/**
 * @function getPublicClansForHub
 * Mengambil SEMUA data cache klan publik dari koleksi 'publicClanIndex'.
 * Digunakan oleh TeamHubPage untuk menampilkan daftar klan publik yang di-cache.
 * @returns Array PublicClanIndex.
 */
...
    // PERBAIKAN 3: Mengambil dari koleksi TOURNAMENTS yang benar
