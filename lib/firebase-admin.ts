...
    }
    ...
    // [PERBAIKAN] Panggilan settings() dipindahkan ke SINI (ke dalam blok 'if').
    // Ini memastikan settings HANYA dipanggil satu kali saat inisialisasi.
...
// [DIHAPUS] Panggilan settings() dipindahkan ke dalam blok 'if' di atas
