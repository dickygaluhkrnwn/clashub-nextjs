 ...
 * CATATAN: Fungsi ini saat ini tidak digunakan dan memiliki path yang salah (seharusnya subcollection).
 * Logika ini ditangani langsung di API Route '.../request/[requestId]/route.ts'.
 * Biarkan di sini untuk referensi, tapi jangan digunakan.
 */
export const updateJoinRequestStatus = async (
  ...
  try {
    // ! PERINGATAN: Path ini salah. Seharusnya sub-koleksi dari managedClans.
