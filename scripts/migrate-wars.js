...
// ... existing code ...
                ...
                const docRef = archiveRef.doc(warId);
                ...
                // dengan ID yang sama (#2G8PU0GLJ-...), atau membuat baru jika belum ada.
                ...
                if (batchCount >= 490) {
                    await batch.commit();
                    console.log(`(Batch) Menyimpan ${batchCount} dokumen untuk ${clanName}...`);
        ...
        if (batchCount > 0) {
            await batch.commit();
            console.log(`(Batch) Menyimpan ${batchCount} dokumen terakhir untuk ${clanName}...`);
        }

        console.log(`--- ✅ Selesai untuk: ${clanName}. Total ${migratedCount} arsip perang (dengan detail) dimigrasi/diperbarui. ---`);
    } // Akhir loop klan
